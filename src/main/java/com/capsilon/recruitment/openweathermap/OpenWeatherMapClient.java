...
public interface OpenWeatherMapClient {
	...
	/**
	 * Retrive data from openweathermap service Sample url:
	 * data/2.5/forecast?q=Warsaw,PL&appid=b6907d289e10d714a6e88b30761fae22
	 * 
	...
	City getWeatherData(@RequestParam("q") String cityAndCountryCode, @RequestParam("appid") String apiKey);
}
